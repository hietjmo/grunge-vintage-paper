...
# time python anim-renesc-3.py -fr 38300 -d brownie3 -st 1
...
after_run = f"ffmpeg -y -framerate 25 -i {folder}/frame-%06d.png -c:v libx264 -profile:v high -crf 20 -pix_fmt yuv420p old-paper-{number}.mp4"
...
for frame in range (0,frames):
  ...
  image.save(f"{folder}/frame-" + str(frame).zfill(6) + ".png", 
    "PNG")
